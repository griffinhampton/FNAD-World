...
import src.dependancyStuff.passwordStuff.password
from src.dependancyStuff.passwordStuff.passwordConfig import *
...
class LoginManager:
    ...
    def login(self):
        ...
        if radiohelp==1:
            ...
            if src.dependancyStuff.passwordStuff.password.password(self.username,self.password) == USERFOUND:
